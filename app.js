            ...
            grupos[rodada].forEach(item => {
                ...
                html += `
                    <div style="margin:8px 0;padding:8px;background:white;border-radius:6px;border:1px solid #c8e6c9">
                        ...
                        Palpite:
                        <input id="pa_${item.id}" value="${va}" placeholder="A" style="width:52px;text-align:center;padding:6px">
                        x
                        <input id="pb_${item.id}" value="${vb}" placeholder="B" style="width:52px;text-align:center;padding:6px">
                    </div>`;
            });
