...
function htmlAbaDesempenho(grupos, allGuesses, participants, uid, gamesSnap, ranking) {
    ...
    const resumoHtml = `
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:12px">
            ...
            <div style="background:var(--color-card-inner);border-radius:8px;padding:10px 12px">
                ...
                <div style="font-size:0.7rem;color:var(--color-muted)">${totalAcertos} de ${totalJogosComResult}</div>
            </div>
            <div style="background:var(--color-card-inner);border-radius:8px;padding:10px 12px">
    ...
    const darkVars = `
        ...
        body:not(.light) .desemp-vars, body.dark .desemp-vars {
            ...
            --color-text-sec: #ccc;
            --color-muted: #999;
            --color-card-inner: #2a3a2a;
            --color-card-inner-b: #1e2e3a;
            --color-bar-bg: #3a3a3a;
            --color-border-hist: #3a3a3a;
        }
        .desemp-vars {
            --color-text: #333;
            --color-text-sec: #555;
