    ...
    app.innerHTML = `
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:2px">
            ...
            <div style="position:relative" id="perfil-wrap">
                ...
                <div id="perfil-menu" style="display:none;position:absolute;top:calc(100% + 6px);right:0;background:#ffffff;border:1px solid #ccc;border-radius:10px;box-shadow:0 4px 20px rgba(0,0,0,0.25);min-width:180px;overflow:hidden;z-index:9999">
                    <div onclick="toggleTheme();togglePerfilMenu()" id="dd-tema" style="display:flex;align-items:center;gap:10px;padding:12px 16px;cursor:pointer;font-size:13px;border-bottom:1px solid #eee;background:#ffffff">
                        <span id="dd-tema-icon" style="font-size:15px">🌙</span><span id="dd-tema-txt" style="color:#222;font-weight:500">Modo escuro</span>
                    </div>
                    <div onclick="abrirAlterarSenha('${id}')" style="display:flex;align-items:center;gap:10px;padding:12px 16px;cursor:pointer;font-size:13px;border-bottom:1px solid #eee;background:#ffffff">
                        <span style="font-size:15px">🔒</span><span style="color:#222;font-weight:500">Alterar senha</span>
                    </div>
                    <div onclick="logout()" style="display:flex;align-items:center;gap:10px;padding:12px 16px;cursor:pointer;font-size:13px;background:#ffffff">
                        <span style="color:#c0392b;font-weight:600">Sair</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="modal-senha" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:9998;align-items:center;justify-content:center;padding:20px">
            <div style="background:#ffffff;border-radius:14px;padding:20px;width:100%;max-width:300px;box-shadow:0 4px 24px rgba(0,0,0,0.2)">
                <h3 style="font-size:15px;font-weight:700;margin-bottom:4px;color:#1b2e1c">🔒 Alterar senha</h3>
                <p style="font-size:11px;color:#888;margin-bottom:14px">${u.name} · Bolão Copa 2026</p>
                <div style="margin-bottom:10px">
                    <label style="font-size:11px;font-weight:600;display:block;margin-bottom:3px;color:#555">Senha atual</label>
                    <input id="senha-atual" type="password" placeholder="Digite sua senha atual" style="width:100%;padding:8px 10px;border:1px solid #ddd;border-radius:8px;font-size:13px;background:#fff;color:#333">
                </div>
                <div style="margin-bottom:10px">
                    <label style="font-size:11px;font-weight:600;display:block;margin-bottom:3px;color:#555">Nova senha</label>
                    <input id="senha-nova" type="password" placeholder="Nova senha" style="width:100%;padding:8px 10px;border:1px solid #ddd;border-radius:8px;font-size:13px;background:#fff;color:#333">
                </div>
                <div style="margin-bottom:10px">
                    <label style="font-size:11px;font-weight:600;display:block;margin-bottom:3px;color:#555">Confirmar nova senha</label>
                    <input id="senha-conf" type="password" placeholder="Repita a nova senha" style="width:100%;padding:8px 10px;border:1px solid #ddd;border-radius:8px;font-size:13px;background:#fff;color:#333">
                </div>
    ...
    jogosParaExibir.forEach(item => {
        ...
        html += `
            <div id="cardj_${item.id}" style="margin:10px 0;padding:18px 14px 12px 14px;background:white;border-radius:10px;border:1px solid #c8e6c9;text-align:center">
                ...
                <button onclick="saveGuessJogo('${item.id}','${uid}')" style="width:100%;padding:10px;font-size:0.9rem;margin-top:10px;border-radius:8px;background:#43a047;color:#fff;border:none;font-weight:600;cursor:pointer">
                    💾 Salvar palpite
                </button>
