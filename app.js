        ...
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:2px">
            ...
            <div style="position:relative" id="perfil-wrap">
                ...
                <div id="perfil-menu" style="display:none;position:absolute;top:calc(100% + 6px);right:0;background:#ffffff;border:1px solid #ccc;border-radius:10px;box-shadow:0 4px 20px rgba(0,0,0,0.25);min-width:180px;overflow:hidden;z-index:9999">
                    ...
                    <div onclick="togglePerfilMenu();abrirAlterarSenha('${id}')" style="display:flex;align-items:center;gap:10px;padding:12px 16px;cursor:pointer;font-size:13px;border-bottom:1px solid #eee;background:#ffffff">
    ...
    jogosParaExibir.forEach(item => {
        ...
        html += `
            <div id="cardj_${item.id}" style="margin:10px 0;padding:18px 14px 12px 14px;background:white;border-radius:10px;border:1px solid #c8e6c9;text-align:center">
                ...
                ${isElimIndiv ? `<button onclick="saveGuessJogo('${item.id}','${uid}')" style="width:100%;padding:10px;font-size:0.9rem;margin-top:10px;border-radius:8px;background:#43a047;color:#fff;border:none;font-weight:600;cursor:pointer">💾 Salvar palpite</button>` : ''}
            </div>
