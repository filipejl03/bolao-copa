...
function htmlAbaDesempenho(grupos, allGuesses, participants, uid, gamesSnap, ranking) {
    ...
    const darkVars = `
        ...
        body:not(.light) .desemp-vars, body.dark .desemp-vars {
            --color-text: #e8f0e8;
            --color-text-sec: #c8d8c8;
            --color-muted: #8fa891;
            --color-card-inner: #2d3b30;
            --color-card-inner-b: #253040;
            --color-bar-bg: #3a4a3c;
            --color-border-hist: #3a4a3c;
            --color-green-val: #7ecf8e;
            --color-blue-val: #85b7eb;
            --color-green-bar: #5dcaa5;
            --color-blue-bar: #6baed6;
        }
        .desemp-vars {
            --color-text: #333;
            --color-text-sec: #555;
