...
function telaManutencao(nomeUsuario) {
    const saudacao = nomeUsuario ? `<p style="color:#888;font-size:0.82rem;margin-bottom:16px">👤 ${nomeUsuario}</p>` : "";
    app.innerHTML = `
        <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:60vh;text-align:center;padding:40px 20px">
            ...
            <button class="btn-red" onclick="logout()" style="margin-top:28px;padding:10px 24px">Sair</button>
        </div>`;
}
